...
gasolinalista=LinkedList()
coordenadalistax=LinkedList()
coordenadalistay=LinkedList()
gasolinavale=0
gasolinalistafull=LinkedList()
xo=0
xf=0
yo=0
yf=0
...
class matriz():
    ...
    def optimize_ways(self,xo, yo, xf,  yf, m, n):
            ...
            while current!=None:
                ...
                try:
                    if current.derecha.row!=None:
                        ...
                        c=int(current.derecha.value)+int(current.value)
                ...
                try:
                    if current.izquierda.row!=None:
                        ...
                        c=int(current.izquierda.value)+int(current.value)
                ...
                try:
                    if current.arriba.row!=None:
                        ...
                        c=int(current.arriba.value)+int(current.value)
                ...
                try:
                    if current.abajo.row!=None:
                        ...
                        c=int(current.abajo.value)+int(current.value)
        ...
        print("\033[1;37m"+"     POSICIÓN FINAL   (",end,")\n"+'\033[0;m')

        print("\033[1;37m"+"\n▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄▀▄"+'\033[0;m')
        
        print("\033[1;36m"+"\n     Calculando la mejor ruta:  ... ***"+'\033[0;m')
       
        time.sleep(1)

        print("\033[1;36m"+"\n\n             La mejor Ruta es:  ... ***"+'\033[0;m')
        ...
        print("\033[1;36m"+" \n        Calculando la cantidad de combustible:  ... ***"+'\033[0;m')
        time.sleep(1)
        ...
        while erow!=None:
            ...
            while current!=None:
                ...
                try:
                    ...
                    if verti in wayslist:

                        gasolinalista.My_Append(current.value)
                        # print(f"LLENANDO coordenadalistax  {current.row},{current.column} ")
                        coordenadalistax.My_Append(current.row)

                        coordenadalistay.My_Append(current.column)                   

                        gasolinavale+=int(current.value)
        ...
        print(gasolinavale, "unidades de gasolina\n")

        gasolinalistafull.My_Append(gasolinavale)
        ...
        try:
            ...
            # fuelobtain=int(fuelobtain)

            # print(fuelobtain , "unidades de gasolina")
            self.imprimir_matriz(int(m), int(n), wayslist)

        except:
            print("\033[1;31m"+"No se puede concluir el recorrido, ya sea que dos o mas caminos son iguales o"+'\033[0;m')
            print("\033[1;31m"+"el valor sobrepasa la cantidad de combustible necesaria del robot R2e2"+'\033[0;m')
            print("\033[1;31m"+"o    F"+'\033[0;m')
        print("\033[1;32m"+"\n       LISTO !:  "+'\033[0;m')
    ...
    def imprimir_matriz(self, m, n, wayslist):
        ...
        print("\033[1;37m"+cadena+'\033[0;m')
